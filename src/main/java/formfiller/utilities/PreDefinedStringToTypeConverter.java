...
public class PreDefinedStringToTypeConverter implements StringToTypeConverter {
	private Map<String, Class<?>> supportedTypes;
	
	public PreDefinedStringToTypeConverter(){
	...
	public Class<?> convert(String abbreviatedName) {
		return supportedTypes.get(abbreviatedName);
	}
